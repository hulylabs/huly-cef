...
RUN chmod +x /tini
ENTRYPOINT ["/tini", "--", "xvfb-run", "-a", "/app/huly-cef-websockets", "--no-sandbox", "--disable-gpu", "--disable-gpu-compositing", "--disable-gpu-rasterization", "--disable-software-rasterizer", "--disable-webgl"]
